...
@Component({
  selector: 'app-mesevolutionentrprise',
  templateUrl: './mesevolutionentrprise.component.html',
  styleUrls: ['./mesevolutionentrprise.component.css']
})
export class MesevolutionentrpriseComponent {
