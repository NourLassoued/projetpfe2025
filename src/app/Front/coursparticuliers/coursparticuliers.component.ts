...
@Component({
  selector: 'app-coursparticuliers',
  templateUrl: './coursparticuliers.component.html',
  styleUrls: ['./coursparticuliers.component.css']
})
export class CoursparticuliersComponent {
  services: Servicee[] = [];
  imageUrls: string[] = [];
  showModal = false;
