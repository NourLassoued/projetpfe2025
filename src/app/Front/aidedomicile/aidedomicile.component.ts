...
@Component({
  selector: 'app-aidedomicile',
  templateUrl: './aidedomicile.component.html',
  styleUrls: ['./aidedomicile.component.css']
})
export class AidedomicileComponent {
     services: Servicee[] = [];
        imageUrls: string[] = [];
        showModal=false;
        ...
        searchServices() {
          ...
          getServicesByCategoryName(categorieName: string): void {
            ...
            placeholders: string[] = [
              "Aide aux personnes âgées 👵❤️",
              "Accompagnement aux courses 🛒",
              "Préparation de repas à domicile 🍽️",
              "Aide aux tâches ménagères 🧹",
              "Assistance pour les rendez-vous 🚗",
