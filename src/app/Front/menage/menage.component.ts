...
export class MenageComponent {
    ...
    constructor(private file:FileService,
        ...
        placeholders: string[] = [
          "Ménage rapide et efficace !",
          "Grand ménage de printemps ?",
          "Nettoyage complet à domicile",
          "Besoin d’un ménage après travaux ?",
          "Tapis, canapés, matelas : on nettoie tout !",
          "Électroménager propre et désinfecté",
          "Lavage auto intérieur et extérieur"
