...
@Component({
  selector: 'app-frontprofilshow',
  templateUrl: './frontprofilshow.component.html',
  styleUrls: ['./frontprofilshow.component.css']
})
export class FrontprofilshowComponent implements OnInit {
