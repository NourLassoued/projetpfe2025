...
@Component({
  selector: 'app-constructionet-grosoeuvre',
  templateUrl: './constructionet-grosoeuvre.component.html',
  styleUrls: ['./constructionet-grosoeuvre.component.css']
})
export class ConstructionetGrosoeuvreComponent {
  services: Servicee[] = [];
  imageUrls: string[] = [];
  showModal = false;
