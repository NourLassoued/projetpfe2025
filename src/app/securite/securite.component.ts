  ...
  services: Servicee[] = [];
    ...
    searchServices() {
      ...
      getServicesByCategoryName(categorieName: string): void {
        ...
        placeholders: string[] = [
      "Protégez votre maison avec la domotique.",
"Sécurisez votre espace avec des systèmes intelligents.",
"Transformez votre maison en espace sécurisé.",
"Optimisez votre sécurité avec la domotique.",
"Maison sécurisée grâce à la domotique.",
